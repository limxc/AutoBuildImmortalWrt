...
| luci-app-ssr-plus + luci-i18n-ssr-plus-zh-cn | SSRP |
| luci-i18n-homeproxy-zh-cn ⭐ | HomeProxy（仅 24.10.x） |
| xray-core / sing-box / hysteria / geoview / naiveproxy | 代理依赖 |
...
| luci-i18n-dufs-zh-cn ⭐ | Dufs 静态文件服务器（仅 24.10.x） |
